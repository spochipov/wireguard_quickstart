...
#   chmod +x server-tools/wg-firewall-recommendations.sh
#   ./server-tools/wg-firewall-recommendations.sh        # dry-run
#   ./server-tools/wg-firewall-recommendations.sh apply  # apply
#
